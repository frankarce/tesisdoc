...
\frontmatter
\begin{abstract}
	Los sistemas de recomendación actualmente son una técnica de filtrado que facilita a los usuarios la búsqueda de información en Internet, especialmente en tiendas virtuales. Son una herramienta  de gran utilidad en los procesos de ventas del comercio electrónico, debido a que proporcionan un valor añadido a los sitios Web comerciales que permite la fidelidad de los clientes. Este es uno de los principales beneficios que esta tecnología ha aportado. 
	En el turismo,  el uso de plataformas basadas en la Web ha tenido una gran difusión debido a su facilidad para integrar sus procesos en modelos Web que implementan algoritmos de recomendación para mejorar la navegación de sus clientes.
	El sistema de recomendación híbrido que se desarrolló en esta investigación aportó beneficios a usuarios que gustan de visitar restaurantes. En la arquitectura se propuso la implementación de dos técnicas de recomendación: filtrado colaborativo y basado en contenido, basados principalmente en información que aportó el usuario al sistema (valoraciones).
Se propuso utilizar información subjetiva mediante un sistema de inferencia difuso para definir la recomendación a través de reglas y atributos difusos que involucren el perfil del usuario y el perfil de  restaurantes. Este sistema fué desarrollado para la ciudad de Tijuana pero se puede adaptar fácilmente a otras ciudades.
\end{abstract}
...
\begin{abstract}
Recommender systems are a filtering technique that help users to find information on Internet, especially in e-commerce. They are a useful tool in e-commerce sales, allows customer loyalty on commercial Web sites.
In tourism, the great use of Web-based platforms because is easy to adapted in  process for Web models that implement recommender algorithms to improve customer's navigation.
The hybrid recommender system developed in this research brings benefits to users love to visit restaurants. The architecture proposes to use two recommender techniques: collaborative filtering  and based content, based in user's ratings both algorithms.
Using subjective information in fuzzy inference system that defines the recommendation through rules and fuzzy attributes involved the user's profile and restaurant's profile. This system is developed for Tijuana, however can be adapted other cities.
\end{abstract}
...
\paragraph{}
Agradezco a mis padres por su paciencia y cariño, todo este esfuerzo es por ellos.
\paragraph{}
A mis hermanos Antonio, Maribel, Rosy, Neli, Jose Manuel por estar siempre conmigo apoyando mis decisiones.
\paragraph{}
Agradezco a mis primos el ánimo, Rogelio y Luis Alberto, a mis tíos Andrés y Alfonsa, gracias por su cariño.
\paragraph{}
A mis amigos Janeth, Maribel, Gladys, Cesar, Lorenzo, a mis amigas a distancia: Arisay, Karina, Cinthy, gracias por el apoyo y amistad de tantos años.
\paragraph{}
Agradezco a mis compañeros por las experiencias durante estos dos años, San Juana, Rosalinda, Leticia, Yuliana, Natanael y Herman, gracias por la amistad y compañerismo.
\paragraph{}
Agradezco su confianza a todos los profesores de la maestría de quienes obtuve mucho más que conocimientos, Dr. José Soria, Dr. Oscar Castillo, Dr. Arnulfo Alanis,  Dra. Patricia Melin, Dr. Miguel Angel López, Dr. Leonardo Trujillo, M.C.C. Alejandra Mancilla, mi admiración y respeto. En especial quiero agradecer  a mi director de tesis Dr. José Mario García Valdéz por su paciencia, tiempo, apoyo y comprensión. 
\paragraph{}
Finalmente mi agradecimiento a ConaCyt por el apoyo otorgado para mis estudios de postgrado.
\clearpage
...
\paragraph{}
Los sistemas de recomendación han ayudado a mejorar la búsqueda de información en Internet \cite{Rucker1997}.  %Checar y agregar una referencia que lo confirme.
...
\bibitem{Adomavicius2005} Adomavicius, A., Gedimias; Tuzhilin (2005). \textit{Towards the Next Generation of Recommender Systems: A Survey of the State-of-the-Art and Possible Extensions.} in it IEEE Trans. Knowl.Data Eng, vol17 (6), (pp.734-749).

\bibitem{Ahn2008} Ahn, H. (2008).\textit{ A New Similarity Measure For Collaborative Filtering To Alleviate The New User Cold Starting Problem.} Information Sciences, (pp. 37-51).

\bibitem{Balabanovic1997} Balabanovic, Y., Marko; Shoham (1997). \textit{Fab: Content-Based, Collaborative Recommendation.} Communications of the ACM, 40 (3).

\bibitem{BarrancoM.J;Mata2008} Barranco, F., M. J; Mata, y Martínez, L. (2008). \textit{REJA: un sistema de recomendación de restaurantes basado en técnicas difusas.} VII Congreso "Turismo y Tecnologías de la información y comunicaciones". Universidad de Jaén., (pp. 1-14).

\bibitem{Basu1998} Basu, H. H., C., y Cohen, W. (1998). \textit{Recommendation as classification: Using social and content-based information in recommendation.} In Recommender Systems.

\bibitem{Billsus1998} Billsus, M., D.; Pazzani (1998).\textit{ Learning collaborative information filters.} In Proceedings of the 15th National Conference on Artificial Intelligence (AAAI-98)., 10 , pp. 46-53.

\bibitem{Billsus2000} Billsus, M., D.; Pazzani (2000). \textit{User modeling for adaptive news access. User Modeling and User-Adapted Interaction.} 10 , 147-180.

\bibitem{Burke2002} Burke, R. (2002). \textit{Hybrid Recommender Systems: Survey and Experiments.} Departament of Information Systems and Decision Sciences, (pp. 1-29).

\bibitem{Claypool1999} Claypool, M., Gokhale, A., Miranda, T., Murnikov, P., Netes, D., y Sartin, M. (1999). \textit{Combining Content-Based and Collaborative Filters in an Online Newspaper. } Computer Science Departament, (pp. 1-8).

\bibitem{Information1997} Council., U. I. T. I. (1997). \textit{The protection of personal data in electronic commerce. Public Policy Document. }

\bibitem{DeCamposLuis2008} De Campos, L. M., Fernández-Luna, J. M., y Huete, J. F. (2008).\textit{ A collaborative recommender system based on probabilistic inference from fuzzy observations.} Fuzzy Sets and Systems, 159 , 1554-1576.

\bibitem{Deshpande2004} Deshpande, M., y Karypis, G. (2004). \textit{Item-Based Top-N Recommendation Algorithms.} ACM Trans. Information Systems, 22 , pp. 143-177.

\bibitem{Espinilla2009} Espinilla, M., Rodríguez, M., Martínez, L., y Barranco, M. (2009). \textit{Sr-reja. Sistema de recomendación híbrido georreferenciado.} International Journal of Hospitality Management, (pp. 147-154).

\bibitem{GalanNieto1994} Galán Nieto, S. M. (2007). \textit{Filtrado Colaborativo y Sistemas de Recomendación.} Inteligencia en Redes de Comunicaciones.

\bibitem{Garcia2009} García-Valdez, M., y Parra, B. (2009). \textit{A Hybrid Recommender System Architecture for Learning Objects.} Evolutionary Design of Intelligent Systems. Tijuana Institute of Technology., (pp. 205-211).

\bibitem{GarciaGil2007} García, F. J., y Gil, A. B. (2007).\textit{ Personalización de Sistemas de Recomendación.} Universidad de Salamanca. Facultad de Ciencias, España. (pp. 1-5).

\bibitem{Garciavaldez2009} García-Valdez, M., Alanis, A., y Parra, B. (2010).\textit{ Fuzzy Inference for Learning Object Recommendation.} IEEE, (pp. 1-6). Technological Institute of Tijuana.

\bibitem{Goldberg1992} Goldberg, D., Nichols, D., Oki, B., y Terry, D. (1992). \textit{Using Collaborative Filtering To Weave An Information Tapestry.} AC Comunications of the ACM.

\bibitem{GuzmanAlvarez} Guzmán  Alvarez, C. A. (2008). \textit{Modelos sub-simbólicos en los Sistemas Recomendadores. Algoritmos genéticos.} DSCI. Universidad Politécnica de Valencia., (pp. 1-8).

\bibitem{Hanley1982} Hanley, J., y Andmcneil, B. (1982). \textit{The meaning and use of the area under a receiver operating characteristic (ROC) curve.} (pp. Radiology 143, 29-36).

\bibitem{Herlocker1991} Herlocker, J. L., Konstan, J. A., Borchers, A., y Riedl, J. (1991). \textit{An Algorithmic Framework for Performing Collaborative Filtering.}  Dep. of Computer Science and Enginnering.

\bibitem{Herlocker2004} Herlocker, J. L., Konstan, J. A., Terveen, L. G., y Riedl, J. T. (2004).\textit{Evaluating Collaborative Filtering Recommender Systems.} 22 (1), (pp. 5-53).

\bibitem{Django2008} Holovaty, A., y Kaplan-moss, J. (2008).\textit{ The Definitive Guide: Web Development Done Right. Django en Español.} Python Argentina. $URL: www.djangoproject.com$

\bibitem{Houstis2002} Houstis, E. N., Catlin, A. C., Dhanjani, N., Rice, J. R., Ramakrishnan, N., y Verykios, V. (2002). \textit{MyPYTHIA: a recommendation portal for scientic software and services.} 1505 (January), (pp.1481-1505).

\bibitem{Jang1997} J.-S.R., S. E. M., Jang; C.-T. (1997). \textit{Neuro-Fuzzy and Soft Computing. A Computacional Approach to Learning and Machine Intelligence.}

\bibitem{Meteren2001} Meteren, R. V., y Someren, M. V. (2001). \textit{Using Content-Based Filtering for Recommendation.} NetlinQ Group., (pp. 1-10).

\bibitem{Porcel2004} Porcel, E. H. L., Carlos; Herrera-Viedma (2004).\textit{ Sistemas de Recomendaciones: herramientas para el filtrado de información en Internet.} Hipertext.net, 2 .

\bibitem{PerezCordon2008} Pérez Cordón, L.-G. (2008). \textit{Modelos de información con falta de información. Aplicaciones al sector turístico.} Universidad de Jaén, España.

\bibitem{Ramezani0000} Ramezani, M., Bergman, L., Thompson, R., Burke, R., y Mobaster, B. (2008). \textit{Selecting and Applying Recommendation Technology. Information Systems,} (pp. 1-9).

\bibitem{Resnick1997} Resnick, P., Varian, H. R., y Guest, E. (1997).\textit{ Recommender Systems.} Communications of the ACM, 40 (3), 56-58.

\bibitem{Cristian2010} Romero, C., García Valdéz, M., y Alanis, A. (2010). \textit{A comparative study of machine learning techniques in blog comments spam filtering in Neural Networks.}  International Joint Conference, (pp. 1-7).

\bibitem{Drake2000} Rossum, G. V. (2000). \textit{Guía de aprendizaje de Python.} Amsterdam: BeOpen Python-Labs.

\bibitem{Rucker1997} Rucker, J., y Polanco, M. J. (1997). \textit{SiteSeer: Personalized Navigation for the Web.} Communications of the ACM, (pp. 73-75).

\bibitem{Sarwar2001} Sarwar, B., Karypis, G., Konstan, J., y Riedl, J. (2001). \textit{Item-Based Collaborative Filtering Recommendation Algorithms.} In In Proceedings of the 10th International World Wide Web Conference (WWW10). GroupLens Research Group, (pp. 285-295).

\bibitem{Schafer2001} Schafer, J., Konstan, J., y Riedl, J. (2001).\textit{E-Commerce Recommender Applications. Data Mining and Knowledge Discovery.}  Norwell, USA, Kluwer Academic Publisher, (pp. 115-153).

\bibitem{Schein2002} Schein, A. I., Popescul, A., Ungar, L. H., y Pennock, D. (2002). \textit{ Methods and metrics for cold-start recommendations.} In Proc. of the 25th Annual Intl. ACM SIGIR Conf.

\bibitem{Segaran2007} Segaran, T., Russell, D., Lead, U. T., Wolters, T., Intellect, C., Tyma, P., y Engineer, S. S. (2007). \textit{Programming Collective Intelligence.} USA: O'Reilly Media Inc. 
$URL: www.oreilly.com$

\bibitem{Soboroff1999} Soborof, I., y Nicholas, C. (1999). \textit{ Combining content and collaboration in text filtering.} Workshop: Machine Learning for Information Filtering.

\bibitem{Terveen1997} Terveen, L., Hill, W., Amento, B., Mcdonald, D., y Creter, J. (1997). \textit{PHOAKS: a system for sharing recommendations.} Human Factors, 59 (March), (pp. 3-5).

\bibitem{wikipedia} Wales, J., y L., S. (2010). Enciclopedia libre Wikipedia. Fecha de consulta: Febrero 2010. $URL: es.wikipedia.org/wiki/SistemaRecomendador$

\bibitem{wikipedia2}  Wales, J., y L., S. (2010). Enciclopedia libre Wikipedia. Fecha de consulta: Diciembre 2010. $URL: es.wikipedia.org/wiki/Logicadifusa$

\bibitem{Wang2004} Wang, Y.-f., Chuang, Y.-l., Hsu, M.-h., y Keh, H.-c. (2004). \textit{A personalized recommender system for the cosmetic business. Expert Systems with Applications,}  26 , (pp. 427-434).
\bibitem{Yager2003} Yager, R. R. (2003). \textit{Fuzzy logic methods in recommender systems.} Fuzzy Sets and Systems, 136 (2), (pp.133-149).
\end{thebibliography}
